...
@Component({
  selector: 'app-recent-professors',
  templateUrl: './recent-professors.component.html',
})
export class RecentProfessorsComponent {
  ...
  ngOnInit() {
    this.api.get('professors').subscribe((data: any) => {
      ...
      this.professors = (data as Professor[]).slice(0, 5);
    });
  }
